...
canvas.draw(lambda x : (1/90)*(x-40)**3 + 50, '3')    # 예시 함수 같이 새로운 함수를 만들지 않고 일회용 함수를 만들어서 넘기는 방법 - f(x) = (1/90)*(x-16)**3 + 19 을 만들어준거임
canvas.show()
...
canvas.draw(lambda x : 10*math.sin((x-40)/5) + 50)         # 삼각함수도 그릴수 있다
canvas.show()
